...
import { OptionalLabelVisibleTest as _OptionalLabelVisibleTest } from "./OptionalLabelVisibleTest.story";
import { HideOptionalLabelTest as _HideOptionalLabelTest } from "./HideOptionalLabelTest.story";
...
export const OptionalLabelVisibleTest = { ..._OptionalLabelVisibleTest };
export const HideOptionalLabelTest = { ..._HideOptionalLabelTest };
