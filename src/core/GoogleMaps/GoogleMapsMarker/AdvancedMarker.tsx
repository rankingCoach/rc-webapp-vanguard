...
export interface HasMarkerAnchor {
  anchor?: google.maps.marker.AdvancedMarkerElement | null | undefined;
}
...
import { MapContext } from '@vanguard/GoogleMaps/map-context';
...
const updaterMap = {
  animation(instance: google.maps.marker.AdvancedMarkerElement, animation: google.maps.Animation): void {
    // instance.setAnimation(animation);
  },
  clickable(instance: google.maps.marker.AdvancedMarkerElement, clickable: boolean): void {
    instance.gmpClickable = clickable;
  },
  cursor(instance: google.maps.marker.AdvancedMarkerElement, cursor: string): void {
    // instance.setCursor(cursor);
  },
  draggable(instance: google.maps.marker.AdvancedMarkerElement, draggable: boolean): void {
    instance.draggable = draggable;
  },
  icon(instance: google.maps.marker.AdvancedMarkerElement, icon: string | google.maps.Icon | google.maps.Symbol): void {
    // instance.setIcon(icon);
  },
  label(instance: google.maps.marker.AdvancedMarkerElement, label: string | google.maps.MarkerLabel): void {
    // instance.setLabel(label);
  },
  map(instance: google.maps.marker.AdvancedMarkerElement, map: google.maps.Map): void {
    instance.map = map;
  },
  opacity(instance: google.maps.marker.AdvancedMarkerElement, opacity: number): void {
    // instance.setOpacity(opacity);
  },
  options(instance: google.maps.marker.AdvancedMarkerElement, options: google.maps.MarkerOptions): void {
  ...
  shape(instance: google.maps.marker.AdvancedMarkerElement, shape: google.maps.MarkerShape): void {
    // instance.setShape(shape);
  },
  title(instance: google.maps.marker.AdvancedMarkerElement, title: string): void {
    instance.title = title;
  },
  visible(instance: google.maps.marker.AdvancedMarkerElement, visible: boolean): void {
    // instance.setVisible(visible);
  },
  zIndex(instance: google.maps.marker.AdvancedMarkerElement, zIndex: number): void {
  ...
  override componentWillUnmount(): void {
    if (this.marker) {
      ...
      if (this.props.clusterer) {
        ...
        this.marker ? (this.marker.map = null) : '';
      }
    }
  }
