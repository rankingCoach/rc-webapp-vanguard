...
import { GradientPrimaryMeshBreaks as _GradientPrimaryMeshBreaks } from './stories/GradientPrimaryMeshBreaks.story';
...
export const GradientPrimaryMeshBreaksBreaks: Story = _GradientPrimaryMeshBreaks;
