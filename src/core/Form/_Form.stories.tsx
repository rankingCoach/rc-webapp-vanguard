...
import { FormAutocompleteValidationMatrix as _FormAutocompleteValidationMatrix } from "./stories/FormAutocompleteValidationMatrix.story";
import { FormValidInputValidationMatrix as _FormValidInputValidationMatrix } from "./stories/FormValidInputValidationMatrix.story";
import { InitialMountStatusContract as _InitialMountStatusContract } from "./stories/InitialMountStatusContract.story";
import { InputCheckboxWithCustomComponent as _InputCheckboxWithCustomComponent } from "./stories/InputCheckboxWithCustomComponent.story";
...
export const FormAutocompleteValidationMatrix: Story = { ..._FormAutocompleteValidationMatrix };
export const FormValidInputValidationMatrix: Story = { ..._FormValidInputValidationMatrix };
export const InitialMountStatusContract: Story = { ..._InitialMountStatusContract };
export const InputCheckboxWithCustomComponent: Story = { ..._InputCheckboxWithCustomComponent };
